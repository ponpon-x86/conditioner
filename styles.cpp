...
namespace styles {
    ...
    QString mode_button_light = ("QPushButton { background-color: #FFF; color: #483F99; font-size: 50px; border: 0px; }"
                                 "QPushButton:pressed { background-color: #DCDBDB; color: #483F99; font-size: 50px; border: 0px; } ");
    QString humidity_button_light = ("background-color: #483F99; color: #FFFFFF; font-size: 30px; border: 0px;");
    ...
    QString scene_light = ("background-color: transparent; margin:20px;");
    QString direction_label_light = ("color: #483F99; font-size: 24px;");
    ...
    QString mode_button_dark = ("QPushButton { background-color: #222; color: #EE2D73; font-size: 50px; border: 0px; }"
                                 "QPushButton:pressed { background-color: #282923; color: #EE2D73; font-size: 50px; border: 0px; } ");
    QString humidity_button_dark = ("background-color: #3C3D38; color: #F8F8F2; font-size: 30px; border: 0px;");
    ...
    QString scene_dark = ("background-color: transparent; margin:20px;");
    QString direction_label_dark = ("color: #F8F8F2; font-size: 24px;");
