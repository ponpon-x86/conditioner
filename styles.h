...
namespace styles {
    extern QString plus_button_light;
    extern QString target_temperature_button_light;
    extern QString real_temperature_label_light;
    extern QString minus_button_light;
    extern QString temperature_background_widget_light;

    extern QString plus_button_dark;
    extern QString target_temperature_button_dark;
    extern QString real_temperature_label_dark;
    ...
    extern int scene_double_margin;
}
